...
class InterfaceRepository(Generic[T]):
    ...
    def find_by_id(self, id_: str) -> T:
        current_collection = self.data_base[self.collection]
        _id = ObjectId(id_)
        # si el _id no esta, el document = None
    ...
    # TODO check if this function could be replaced by saved
...
# TRANSFORMACIONES DE MONGO A PYTHON
...
# TRANSFORMACIONES DE PYTHON A MONGO
